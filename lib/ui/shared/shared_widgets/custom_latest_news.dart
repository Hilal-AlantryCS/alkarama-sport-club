...
class CustomLatestNews extends StatelessWidget {
  ...
  const CustomLatestNews({super.key, this.marginend, this.marginstart, this.margintop, this.marginbottom});

  @override
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsetsDirectional.only(end: marginend??screenWidth(30),start:marginstart??screenWidth(30),bottom:marginbottom?? screenWidth(30), ),
...
الوثبة بهدفين مقابل هدف  ''',styleType: TextStyleType.SUBTITLE,textColor: AppColors.blackColor,fontSize:screenWidth(26.8),),
              ...
              Row(              
                children: [
                  CustomRow(icon: 'ic_eye', text: '300',color: AppColors.greyColor,textColor: AppColors.greyColor,styleType: TextStyleType.BODY,),
                  SizedBox(width: screenWidth(6),),
                  CustomRow(icon: 'Vector', text: '4 أيام',color: AppColors.greyColor,textColor: AppColors.greyColor,styleType: TextStyleType.BODY,),
                ],
              )
              ],
            ),
