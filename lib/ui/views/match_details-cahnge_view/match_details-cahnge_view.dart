       ...
       body: Padding(
        ...
        child: Column(
          children: [
            CustomMatch(),
            SizedBox(height: 20,),
            CustomRowText(isSelestedone: false, isSelestedtwo: true, isSelestedthree: false),
             SizedBox(height: 40,),
            Row(
              ...
              children: [
                StaffDetails(
                      ...
                      Image.asset('assets/images/pngs/switch.png',width: screenWidth(15),height: screenWidth(15),),
                       StaffDetails(
                        backgroundColor: AppColors.blueColor,
                        isPlayer: true,
                        isGk: false,
